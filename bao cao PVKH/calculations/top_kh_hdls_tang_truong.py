import pandas as pd
from data_connect.db_connect import bao_cao_ket_qua_hdls_2025_2026

COL_GROWTH = "Tăng trưởng lợi nhuận (%)"
COL_LN_2025 = "Lợi nhuận 2025 (tr VND)"
LN_2025_THRESHOLD = 500  # tr VND — matches bao_cao_ket_qua_hdls_2025_2026_view's own
# WHERE COALESCE(y25.ln_tr_dong, 0) > 500, applied explicitly here so the % growth ranking
...
if __name__ == "__main__":
    ...
    df = bao_cao_ket_qua_hdls_2025_2026(latest_date())
