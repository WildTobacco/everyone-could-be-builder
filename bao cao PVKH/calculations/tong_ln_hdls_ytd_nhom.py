...
@_df_cache()
def tong_ln_hdls_ytd_by_nhom(date_str: str):
    """Tong_LN_HDLS_YTD_Nhom: MAX(pvkh_pstc_nhom_phu_trach[sum_ln_hdls_luy_ke]) at the latest
    ...
    by_group = df.groupby("nhom_phu_trach")["sum_ln_hdls_luy_ke"].max()
...
if __name__ == "__main__":
    ...
    d = latest_date()
    print(f"date: {d}")
    print(tong_ln_hdls_ytd_by_nhom(d))
