...
@_df_cache()
def tong_ds_mbnt_ytd_by_nhom(date_str: str):
    df = pvkh_mbnt_nhom_phu_trach(date_str)
    by_group = df.groupby("nhom_phu_trach")["sum_ds_mbnt_luy_ke_den_ngay_bc"].max()
...
if __name__ == "__main__":
    print(tong_ds_mbnt_ytd_by_nhom(latest_date()))
